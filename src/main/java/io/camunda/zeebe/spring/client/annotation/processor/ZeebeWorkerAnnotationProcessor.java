...
import org.camunda.consulting.ZeebeExpressionResolver;
...
public class ZeebeWorkerAnnotationProcessor extends AbstractZeebeAnnotationProcessor {
    ...
    @Autowired
    ZeebeExpressionResolver zeebeExpressionResolver;
    ...
    public Optional<ZeebeWorkerValue> readJobWorkerAnnotationForMethod(final MethodInfo methodInfo) {
        ...
        if (methodAnnotation.isPresent()) {
            ...
            String type ="";
            if(annotation.type().contains("${")){
                type = zeebeExpressionResolver.resolve(annotation.type());
            }else{
